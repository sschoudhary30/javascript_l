...
const tinderUser = {}; // ye ek non singleton object hai,  both same only both will return object or ye constructor type.
...
//api = value coming from backend // api send data in json format.
